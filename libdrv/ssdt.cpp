...
*/
{
    ...
    CreateFile = reinterpret_cast<SIZE_T>(MiFindExportedRoutineByName(GetNtBase(), &File));
    CreateKey = reinterpret_cast<SIZE_T>(MiFindExportedRoutineByName(GetNtBase(), &Key));
