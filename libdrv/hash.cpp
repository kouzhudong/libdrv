...
*/
{
    ...
    do {
        ...
        // PERFORMANCE: Consider using 64KB buffer (0x10000) instead of 16KB for better I/O throughput
        // Current: nread = PAGE_SIZE * 4 (16KB). Recommended: 0x10000 (64KB, same as KFC_MAX_TRANSFER_SIZE)
