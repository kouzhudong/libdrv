...
typedef NTSTATUS(WINAPI * VirtualMemoryCallBack)(_In_ HANDLE Pid, _In_ PMEMORY_BASIC_INFORMATION MemoryBasicInfo, _In_opt_ PVOID Context);
...
//所以有此定义。
typedef NTSTATUS(NTAPI * ZwQueryVirtualMemory_PFN)(
